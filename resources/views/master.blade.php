...
<head>
    ...
    <script nonce="a78a1dcc-b2f6-44dd-8a2a-3c0f33f71aa2">
        (function(w, d) {
            ! function(a, e, t, r, z) {
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="adminlte/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
                    class="brand-image img-circle e levation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Ăn vặt Hồng Hân</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        ...
                        <img src="https://scontent.fsgn13-2.fna.fbcdn.net/v/t1.6435-9/118090811_1054651338312759_4333434083696256448_n.jpg?_nc_cat=108&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=kgS3epNN4uEAX_EgfHw&_nc_ht=scontent.fsgn13-2.fna&oh=00_AT-iE4ELCzhq6YuZ7KBDwFLaa7Ja4HeU2u4uvxJHCDgifA&oe=624C6314"
                            class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Huỳnh Hồng Hân</a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            <strong>Liên hệ: <a href="https://www.facebook.com/honghan.1303">Huỳnh Hồng Hân</a>.</strong>
            - SĐT: 0825828346
